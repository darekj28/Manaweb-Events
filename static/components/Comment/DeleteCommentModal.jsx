				...
				<div className="modal-dialog" role="document">
					<div className="modal-content">
						...
						<div className="modal-body" id="DeleteCommentModalBody">
							<button id='dcm_yes' type="button" className="btn btn-default modal-button" data-dismiss="modal" 
									onClick={this.handleCommentDelete.bind(this)}>Yes</button>
							<button id="dcm_no" type="button" className="btn btn-default modal-button" data-dismiss="modal">No</button>
						</div>
					</div>
				</div>
			</div>
